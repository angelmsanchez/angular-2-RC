...
export class SeedConfig {
  ...
  */
   ...
   * @type {string}
   */
  APP_TITLE = 'Welcome to angular-2-RC';
  ...
  APP_ASSETS: InjectableDependency[] = [
    ...
    { src: `${this.SASS_SRC}/style.${this.getInjectableStyleExtension()}`, inject: true, vendor: false }
