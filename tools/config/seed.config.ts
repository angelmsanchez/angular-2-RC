...
export class SeedConfig {
    ...
    */
     ...
     * used or not.
     * Per default (non hot-loader mode) the `` file will be used, with the hot-loader option enabled, the
     * `hot_loader_` file will be used.
     * @type {string}
     */
    ...
    /**
     * The folder for the built SCSS files.
     * @type {strings}
     */
    ...
    APP_ASSETS: InjectableDependency[] = [
        ...
        { src: `${this.SCSS_SRC}/style.${this.getInjectableStyleExtension()}`, inject: true, vendor: false },
    ];
